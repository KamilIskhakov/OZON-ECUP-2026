"""v25 = v23 + направление факторизованной головы LGB.

Коэффициент равен ЕДИНИЦЕ по построению: направление уже содержит
вес 0.4 LGB-части внутри себя, и подгонки нет. Поэтому цены за
подогнанный по лидерборду параметр (около 2.2e-5) здесь не возникает.

Направление демеанировано: уровень v23 задан ручкой a_m = 0.18,
подобранной по лидерборду, и валидировалась форма, а не уровень.
"""
...
name = 'submission_v25_facthead.csv'
